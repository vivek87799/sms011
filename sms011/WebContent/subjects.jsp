...
<body>
			...
			<div id="middle">
				...
				<div id="board">
					...
					<div >
						...
						<input type="radio" name="type" id="subject" value="subject" onclick="fun()">SUBJECT INFO<br> <input type="radio"
 ...
 %>
						...
						<input type="radio" name="type" id="extra" value="extra"
							onclick="fun()">EXTRA CURRICULAR INFO
						<%
							}
							} else {
						%>
 ...
 %>
					...
					%>
					<table>
<tr><td><input type="hidden" name="val" id="val" value="9">
...
<tr>
 ...
 <td><input type="text" name="subcode" id="subcode" value="<%=code%>"></td>
 <%}else{ %>
 <td><input type="text" name="subcode" id="subcode" value="<%=code%>" readonly></td>
 <%} %>
...
<tr>
	...
	<td><input type="text" name="subname" id="subname" value="<%=name%>"></td>
	<td colspan="2"><span id="subnameerror"></span></td>
</tr>
<tr>
	<td> <p:Label label="max_marks"/>  </td>
	<td><input type="text" name="maxmarks" id="maxmarks" value="<%=max%>"></td>
	<td colspan="2"><span id="maxmarkserror"></span></td>
</tr>
<tr>
	<td> <p:Label label="pass_marks"/> </td>
	<td><input type="text" name="passmarks" id="passmarks" value="<%=pass%>"></td>
	<td colspan="2"><span id="passmarkserror"></span></td>
					...
					<p:Button name="update" type="button" value="update" onclick="fun1(4)" />
					...
					<table>
						...
						%>
						<tr>
							<td><p:Button name="edit" type="button" value="edit" onclick="fun1(1)" /></td>
							<td><p:Button name="delete" type="button" value="delete" onclick="fun1(2)" /></td>
						</tr>
					</table>
					<%}  }
...
<tr>
	...
	<%if(code.equalsIgnoreCase("")) {%>
 <td><input type="text" name="extracode" id="extracode" value="<%=code%>"></td>
 <%}else{ %>
 <td><input type="text" name="extracode" id="extracode" value="<%=code%>" readonly></td>
 <%} %> 
	<td colspan="2"><span id="extracodeerror"></span></td>
</tr>
<tr>
	<td>Extra Curricular Name</td>
	<td><input type="text" name="extraname" id="extraname" value="<%=name %>"/></td>
...
if(io1.hasNext()){
	...
	<table>
	<tr>
		<td><input type="radio" name="r_extra" value="<%=vo.getExtra_code()%>"></td>
		...
		<% } %>
		<tr><td><p:Button name="edit" type="button" value="edit" onclick="fun1(1)"/>  </td>
		<td><p:Button name="delete" type="button" value="delete" onclick="fun1(2)"/> </td>
		</tr>
	</table>	
	<% 
